...
function App() {
  ...
  const appid = ["6c9498545f0b7e313acac5a7166677ea", "af3eda7c637910e6048fe05760c13f9d", "76408e74d198f03f5d26f16eacb33d1f"]; 

  const urlFirst = `https://api.openweathermap.org/data/2.5/weather?q=${selectedCity},tr&appid=${appid[2]}`
  ...
  const getWeather = (data) => {
    const urlSecond = `https://api.openweathermap.org/data/2.5/onecall?lat=${data?.coord.lat}&lon=${data?.coord.lon}&units=metric&exclude=hourly,current,minutely,alerts&appid=${appid[2]}`;
